...
def main():
    ...
    model.to(device)
    model.load_state_dict(torch.load(f'/opt/ml/Project/VQA/models/1020_{model_name}.pth'))
    ...
    save_pth=f'/opt/ml/Project/VQA/models/1020_{model_name}.pth'
